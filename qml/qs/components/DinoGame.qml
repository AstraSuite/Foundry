...
Item {
    ...
    function spawnObstacle() {
        ...
        if (rand === 0 || rand === 1) {
            ...
            if (heightLevel === 0) objY = ground.y - 85
            else if (heightLevel === 1) objY = ground.y - 65
            else objY = ground.y - 40
        }
    ...
    Item {
        ...
        Image {
            ...
            source: {
                ...
                if (dinoY < groundLevel - 1) return Paths.absolutePath("root:/assets/dino/Chrome_T-Rex_Left_Run.png")
