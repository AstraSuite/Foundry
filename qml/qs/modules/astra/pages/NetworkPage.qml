...
PageBase {
    ...
    ColumnLayout {
        ...
        Timer {
            ...
            interval: GlobalConfig.astra.networkRescanInterval
        ...
        NetworkList {
            Layout.bottomMargin: Nmcli.wifiEnabled && Nmcli.networks.length > GlobalConfig.astra.maxNetworksShown ? 0 : -parent.spacing
            nState: root.nState
            limit: GlobalConfig.astra.maxNetworksShown
        ...
        RowButton {
            Layout.preferredHeight: Nmcli.wifiEnabled && Nmcli.networks.length > GlobalConfig.astra.maxNetworksShown ? implicitHeight : 0
            clip: true
            ...
            delegate: Item {
                ...
                RowLayout {
                    ...
                    Item {
                        ...
                        opacity: provider.isConnected && root?.cappedWidth > Tokens.sizes.astra.networkShowVpnDetailWidth ? 1 : 0
                        visible: opacity > 0

                        implicitWidth: provider.isConnected && root?.cappedWidth > Tokens.sizes.astra.networkShowVpnDetailWidth ? providerDetailRow.implicitWidth : 0
