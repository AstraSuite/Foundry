...
PageBase {
    ...
    component AppRow: PopupRow {
        ...
        popup.topMovement: Math.max(Tokens.sizes.astra.minPopupHeight - popupHeight, Tokens.padding.large)
        ...
        Loader {
            ...
            sourceComponent: VerticalFadeListView {
                ...
                implicitWidth: Tokens.sizes.astra.popupWidth
                implicitHeight: CUtils.clamp(aroot.popupHeight, Tokens.sizes.astra.minPopupHeight, Tokens.sizes.astra.maxPopupHeight)
