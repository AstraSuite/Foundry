...
class Config : public QQuickAttachedPropertyPropagator, public QQmlParserStatus {
    ...
    Q_PROPERTY(const caelestia::config::AstraConfig* astra READ astra NOTIFY sourceChanged)
...
public:
    ...
    [[nodiscard]] const AstraConfig* astra() const;
